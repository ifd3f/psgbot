...
testgrammar =
  ...
  Map.fromList
    [ ( Ident "S1"
      , Rule
          []
          (Fix $ Fix <$> CatE [RuleE (Ident "NP") [], RuleE (Ident "VP") []]))
    , ( Ident "S2"
      , Rule
          []
          (Fix $
    ...
    , ( Ident "VP"
      , Rule
          []
          (Fix $ Fix <$> CatE [RuleE (Ident "V") [], RuleE (Ident "NP") []]))
    , ( Ident "V"
      , Rule
          []
          (uniformUnionE
    ...
    , ( Ident "N"
      , Rule
          []
          (uniformUnionE [Fix $ LitE "cat", Fix $ LitE "dog", Fix $ LitE "fox"]))
    , ( Ident "D"
      , Rule
          []
          (uniformUnionE [Fix $ LitE "the", Fix $ LitE "a", Fix $ LitE "that"]))
    , ( Ident "Adj"
      , Rule
          []
          (uniformUnionE
